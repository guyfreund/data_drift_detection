...
GERMAN_CREDIT_DEPLOYMENT_DATASET_PATH = os.path.abspath(os.path.join(__file__, "..", "raw_files", f"generated_GermanCreditDataset.csv"))
GERMAN_CREDIT_DEPLOYMENT_DATASET_PLUS_PATH = os.path.abspath(os.path.join(__file__, "..", "raw_files", f"generated_GermanCreditDataset_plus.csv"))
...
BANK_MARKETING_DEPLOYMENT_DATASET_PATH = os.path.abspath(os.path.join(__file__, "..", "raw_files", f"generated_BankMarketingDataset.csv"))
BANK_MARKETING_DEPLOYMENT_DATASET_PLUS_PATH = os.path.abspath(os.path.join(__file__, "..", "raw_files", f"generated_BankMarketingDataset_plus.csv"))
